...
<div><!-- 取消row -->
	  ...
	  <table class="table table-bordered table-striped table-condensed" style="font-size:14px">
	    <tr>
	     ...
	     <tr>
			<td><a href="<%=request.getContextPath()%>/stat/singlelivedata?ghId=21" class="text-success"><span class="glyphicon glyphicon-link"></span>&nbsp;&nbsp;温室&nbsp;&nbsp;001</a></td>
	     ...
	     <tr>
			<td><a href="<%=request.getContextPath()%>/stat/singlelivedata?ghId=22" class="text-success"><span class="glyphicon glyphicon-link"></span>&nbsp;&nbsp;温室&nbsp;&nbsp;002</a></td>
	     ...
	     <tr>
			<td><a href="<%=request.getContextPath()%>/stat/singlelivedata?ghId=23" class="text-success"><span class="glyphicon glyphicon-link"></span>&nbsp;&nbsp;温室&nbsp;&nbsp;003</a></td>
	     ...
	     <tr>
			<td><a href="<%=request.getContextPath()%>/stat/singlelivedata?ghId=24" class="text-success"><span class="glyphicon glyphicon-link"></span>&nbsp;&nbsp;温室&nbsp;&nbsp;004</a></td>
	     ...
	     <tr>
			<td><a href="<%=request.getContextPath()%>/stat/singlelivedata?ghId=25" class="text-success"><span class="glyphicon glyphicon-link"></span>&nbsp;&nbsp;温室&nbsp;&nbsp;005</a></td>
	     ...
	     <tr>
			<td><a href="<%=request.getContextPath()%>/stat/singlelivedata?ghId=26" class="text-success"><span class="glyphicon glyphicon-link"></span>&nbsp;&nbsp;温室&nbsp;&nbsp;006</a></td>
