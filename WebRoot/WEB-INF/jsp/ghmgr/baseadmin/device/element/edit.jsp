...
$().ready(function() {
 $("#editelementForm").validate();
	...
	<form id="editelementForm"
		action="<%=request.getContextPath()%>/device/element/device_update?elementId=${Element.element_id}"
		method="post">
		...
		<div style="width: 60%; margin: 20px auto;">
			<table class="table table-bordered table-condensed">
				<tr>
					...
					<td><input type="text" value="${Element.element_nam}"
						id="Element_nam" name="Element_nam" class="required form-control"></td>
				</tr>
				<tr>
					<td class="text-center">检测元素类型:</td>
					<td><input type="text" value="${Element.element_type}"
						id="Type" name="Type" class="required form-control"></td>
				</tr>
				<tr>
					<td class="text-center">检 测频 率:</td>
					<td><input type="text" value="${Element.element_rate}"
						id="Element_rate" name="Element_rate"
						class="required number form-control"></td>
				</tr>
				<tr>
					<td class="text-center">单 位:</td>
					<td><input type="text" value="${Element.element_unit}"
						id="Element_unit" name="Element_unit"
						class="required form-control"></td>
				</tr>
				<tr>
					<td class="text-center">偏 &nbsp移&nbsp 量:</td>
					<td><input type="text" value="${Element.element_offset}"
						id="Element_offset" name="Element_offset"
						class="required number form-control"></td>
				</tr>
				<tr>
					<td class="text-center">数 据类 别:</td>
					<td><input type="text" value="${Element.data_type}"
						id="Data_type" name="Data_type" class="required form-control"></td>
				</tr>
				<tr>
