...
$().ready(function() {
 $("#editdeviceForm").validate();
	...
	<form id="editdeviceForm"
		action="<%=request.getContextPath()%>/device/gh/device_update?deviceId=${Setup_Con.equip_id}"
		method="post">
		<div style="width: 60%; margin: 20px auto;">
			<table class="table table-bordered table-condensed">
				...
				<tr>
					...
					<td><input type="text" value="${Setup_Con.name}" id="Name"
						name="Name" class="required form-control"></td>
				</tr>
				<tr>
					<td class="text-center">设备类型:</td>
					<td><input type="text" value="${Setup_Con.type}" id="Type"
						name="Type" class="required form-control"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><textarea id="Remark" name="Remark" class="form-control">${Setup_Con.remark}</textarea></td>
				</tr>
				<tr>
