...
<div class="sidebar-nav">
	...
	<ul id="gh-menu1" class="nav nav-list collapse  in">
	 ...
	 --%>
	<a href="<%=request.getContextPath()%>/stat/livedata"
		class="my-nav-header" style="border-bottom: 1px solid #ccc;"
		target="main"><span class="glyphicon glyphicon-home"></span>&nbsp;&nbsp;主页</a>
	...
	<c:if test="${not empty list}">
		<c:forEach items="${list}" var="greenhouse">
			<!-- 27为灌溉系统的温室id -->
			<c:if test="${greenhouse.GH_id != 27 && greenhouse.GH_id != 28 }">
				<a href="#${greenhouse.GH_code}" class="my-nav-header"
					data-toggle="collapse"><span class="icon-th iconSpan"></span>&nbsp;&nbsp;温室&nbsp;&nbsp;${greenhouse.GH_code}</a>
				<ul id="${greenhouse.GH_code}" class="nav nav-list collapse in">
					<li><a
						...
						target="main"><span class="glyphicon glyphicon-stats"></span>&nbsp;&nbsp;实时数据&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
					<li><a
					...
					<a href="#inner${greenhouse.GH_code}" class="my-nav-header bgn"
						data-toggle="collapse" style="background: none;"><span
						class="glyphicon glyphicon-cog text-success"></span>&nbsp;&nbsp;参数设定&nbsp;&nbsp;</a>
					<ul id="inner${greenhouse.GH_code}" class="nav nav-list collapse">
						<li><a
							href="<%=request.getContextPath()%>/ghmgr/editgh?ghId=${greenhouse.GH_id}"
							target="main"><span class="glyphicon glyphicon-th-large"></span>&nbsp;&nbsp;温室结构&nbsp;&nbsp;&nbsp;&nbsp;</a>
						</li>

						<li><a
							href="<%=request.getContextPath()%>/ghmgr/ghadmin/crop/list?ghid=${greenhouse.GH_id}"
							target="main"><span class="glyphicon glyphicon-leaf"></span>&nbsp;&nbsp;作物管理&nbsp;&nbsp;&nbsp;&nbsp;</a>
						</li>
			...
			<c:if test="${greenhouse.GH_id == 27 }">
				<a href="#${greenhouse.GH_code}" class="my-nav-header"
					data-toggle="collapse"><span class="glyphicon glyphicon-tint"></span>&nbsp;&nbsp;灌溉系统&nbsp;&nbsp;</a>
				<ul id="${greenhouse.GH_code}" class="nav nav-list collapse in">
					<li><a
						href="<%=request.getContextPath()%>/stat/singlelivedata?ghId=${greenhouse.GH_id}"
						target="main"><span class="glyphicon glyphicon-stats"></span>&nbsp;&nbsp;实时数据&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
